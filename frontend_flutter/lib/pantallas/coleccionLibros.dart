...
class _PantallaColeccionState extends State<PantallaColeccion> {
  ...
  void initState() {
    super.initState();
    // Se ejecuta la búsqueda inicial. Como Libreria.todosLosLibros ya se cargó en el main, aquí ya habrá datos disponibles.
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async {
          await Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => PantallaGestionLibro()),
          );
